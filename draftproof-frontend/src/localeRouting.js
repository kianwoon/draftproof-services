...
export const LOCALIZABLE_PUBLIC_PATHS = ['/', '/why', '/features', '/technology', '/rewrite', '/content-checker', '/turnitin-ai-score', '/academic-integrity-ai', '/ai-declaration', '/reduce-ai-detection', '/turnitin-vs-ai-detectors', '/pricing', '/faq', '/privacy', '/security', '/signin'];
