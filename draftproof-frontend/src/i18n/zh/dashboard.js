export const dashboard = {
  ...
  "freeScanNote": "新账户注册即获赠 5 个免费积分，足够试用前几次扫描。",
  ...
  "rewriteStartsFromReport": "改写从这份报告开始",
  "openReports": "打开报告",
  "steps": [
    {
      "title": "粘贴草稿",
  ...
  "manualSteps": [
    {
      "title": "阅读段落诊断",
      "body": "打开扫描报告。每个被标记的段落都说明了风险是什么、为什么有风险——把它当作你的修改说明。"
    },
    {
      "title": "亲自修改草稿",
      "body": "回到你的原始文档，加入你自己的证据，用你的语气重新表达，亲手为每个薄弱论点补充依据。"
    },
    {
      "title": "重新扫描确认",
      "body": "将修改后的文字粘贴到新扫描中，确认被标记的缺口已经补上——有依据的论点、真实的来源、你自己的表达。"
    }
  ]
};
