export const landing = {
  ...
  "detectorUpdateNote": "检测器刚完成微调，训练数据涵盖前沿 AI（GPT5.x/Gemini/Qwen 等）生成文本与数千篇真实文章 —— 检测准确率提升的同时，英语非母语写作者的误判率控制在 1% 以下。",
  ...
  "policyAwareEyebrow": "无论政策如何，都能识别",
  "policyAwareTitle": "学校的 AI 政策会改变标准。DraftProof 也会按这个标准来读。",
  "policyAwareBody": "同样的检测器，不同的评判标准：DraftProof 依据你课程实际允许的范围来衡量草稿，而不是套用统一的门槛。",
  "sampleEyebrow": "示例报告",
