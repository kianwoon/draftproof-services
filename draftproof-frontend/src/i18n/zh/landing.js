export const landing = {
  "heroPill": "面向学生的依据优先论文审阅",
  "heroTitle": "在别人质疑之前，先看清论文哪里需要更强证据。",
  "heroTitleHighlight": "更强证据",
  "heroLead": "DraftProof 会审阅引用缺口、来源适配、论断依据、相似度风险和类似 AI 的写作信号，并把它们转化为提交前可执行的修改计划。",
  "runCheck": "审阅我的论文",
  "viewSample": "查看示例报告",
  ...
  "humanizerBody1": "AI“人性化工具”承诺通过改词和打乱句式让文本无法被检测。这样可能让文字变得生硬、模糊你的原意，却没有解决真正的问题：论断缺少清楚证据或作者自己的推理。",
  "humanizerBody2": "Turnitin 指南说明，AI 报告可能包含经过释义、改写或规避工具处理的文本，同时 AI 报告需要人类判断，因为它可能误判文本。DraftProof 不玩这个游戏：我们告诉你哪里需要补依据、核实并用自己的话完成。",
  ...
  "anchorBody1": "检测分数可能变低，但读者仍然会觉得文章不够好。如果草稿中的论断太薄、来源连接不清、缺少作者自己的推理，或没有回应作业要求，就没有足够真实材料可以修改。只打乱有限词句，只是在移动同一个弱点。",
  "anchorBody2": "DraftProof 把内容当作根本输入：论断说了什么、哪个来源支撑它、作者本人能解释什么、作业实际要求什么。最强的修改不是把文字伪装得更顺，而是让这些锚点更清楚地留在文中。",
  ...
  "strategyBody": "大学论文、研究段落、政策说明和个人反思不应该用同一种方式修改。DraftProof 会先理解你写了什么，再建议哪里需要补证据、上下文或作者自己的推理。",
  "strategyProofStrong": "DraftProof 不会盲目“人类化”文本。",
  "strategyProofBody": "它帮助学生针对自己真实写出的论文修复引用、来源支撑、相似度和类似 AI 表达风险，并把改写结果视为需要审阅的草稿，而不是直接提交的文本。",
  "engineEyebrow": "工作方式",
