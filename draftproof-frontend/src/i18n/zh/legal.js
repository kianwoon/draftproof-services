    ...
    "sections": [
      {
        ...
        "items": [
          ...
          {
            "title": "文档",
            "body": "你上传用于扫描的文件，通常是论文、报告或研究文章，会被临时存储，以便我们分析并生成报告。"
          },
          {
            "title": "扫描结果",
          ...
          {
            "title": "付款信息",
            "body": "我们使用 Stripe 处理付款。我们不会看到或存储你的信用卡号，只保存令牌化确认和令牌购买记录。"
          }
        ]
      },
      {
        ...
        "bullets": [
          ...
          "令牌计费：Stripe 处理一次性令牌购买，我们跟踪你的余额。"
        ]
      },
      {
        "title": "数据存储",
    ...
    "sections": [
      ...
      },
      {
        ...
        "bullets": [
          ...
          "基于令牌计费：我们跟踪预付令牌余额，不在我们侧进行周期扣费或保存付款方式。"
        ]
      },
      {
        "title": "应用安全",
