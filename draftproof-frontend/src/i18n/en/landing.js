export const landing = {
  ...
  "policyAwareEyebrow": "Policy-aware, either way",
  "policyAwareTitle": "Your school's AI policy changes the bar. DraftProof reads it that way too.",
  "policyAwareBody": "Same detector, different rubric: DraftProof weighs your draft against what your course actually allows, not one universal cutoff.",
