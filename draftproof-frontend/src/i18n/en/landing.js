export const landing = {
  ...
  "humanizerBody1": "AI \"humanizers\" promise undetectable text by changing words and sentence patterns. That can make writing awkward, blur your meaning, and leave the real problem untouched: claims that need clearer evidence or author-owned reasoning.",
  "humanizerBody2": "Turnitin guidance says AI reports may include text modified by paraphrasing, word-spinner, or bypasser tools, and that AI reports need human judgment because they can misidentify text. DraftProof does not play that game: it shows what to ground, verify, and finish in your own words.",
  ...
  "anchorBody1": "A detector can be satisfied while the paper still fails the reader. If the draft has thin claims, weak source links, missing author reasoning, or no assignment-specific context, there is not enough real material to revise. Shuffling limited words only moves the same weakness around.",
  "anchorBody2": "DraftProof treats content as the root input: what the claim says, which source supports it, what the author can explain, and what the assignment actually asks for. The strongest revision keeps those anchors visible instead of hiding them under smoother wording.",
  ...
  "helpTitle": "Prepare your essay before review.",
  ...
  "strategyBody": "A college essay, research paragraph, policy note, and personal reflection should not be revised the same way. DraftProof first understands what you wrote, then suggests where to add evidence, context, or author-owned reasoning.",
  "strategyProofStrong": "DraftProof does not blindly humanize text.",
  "strategyProofBody": "It helps students fix citation, grounding, similarity, and AI-like wording risks in the essay they actually wrote, then treats rewrite output as something to review, not submit untouched.",
