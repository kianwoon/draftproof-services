...
export const seo = {
  ...
  "essayCheckerDescription": "Unlike GPTZero or Turnitin, DraftProof tells you exactly why each paragraph is flagged — then coaches you through a rewrite you finish in your own words. Check citations, source grounding, and submission risk before you submit. No institution account needed.",
  "essayCheckerSocialDescription": "Unlike GPTZero or Turnitin, DraftProof explains why you're flagged — then coaches you to fix it in your own words. No institution needed.",
  ...
  "reduceDetectionDescription": "Trying to beat AI detectors is the wrong goal — and a risky one. The honest truth about reducing AI detection, why humanizers backfire, and what actually lowers your real submission risk.",
