export const report = {
  ...
  "submitted": {
    ...
    "editor": {
      ...
      "amberGuideCopy": "These sentences were kept as-is — the rewrite couldn't safely improve them without inventing facts, so grounding them is yours to do. Rewrite each in your own words with concrete, specific detail; the worked examples below show the move.",
