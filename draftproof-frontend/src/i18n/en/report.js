export const report = {
  ...
  "whatToFixFirst": {
    ...
    "kickerLow": "Polish",
    "titleLow": "Optional polish",
    "introLow": "This already reads as your own work. To make it even harder to question, ground these claims in a specific only you could know — a name, a number, an observation. Sentence-level notes are in the highlights below.",
  ...
  "signals": {
    ...
    "labels": {
      ...
      "ai_signal_deep_scan": "Passages to review (beta deep-scan)"
    },
    "descriptions": {
  ...
  "submitted": {
    ...
    "position": "{{current}} of {{total}} flagged paragraphs",
    ...
    "paragraphSignals_one": "{{count}} flagged sentence in paragraph",
    "paragraphSignals_other": "{{count}} flagged sentences in paragraph",
  ...
  "authorshipBreakdown": {
    ...
    "deepScan": {
      ...
      "paragraphs": {
        ...
        "flaggedDetail_one": "{{flagged}} of {{count}} sentence flagged",
        "flaggedDetail_other": "{{flagged}} of {{count}} sentences flagged",
        "belowFloor": "{{pct}}% — below the {{floor}}% reliability floor, too few to judge this paragraph",
        "atOrAboveFloor": "at or above the {{floor}}% reliability floor"
      }
    },
