...
function renderRoute(html, pathname) {
  ...
  return [
    ...
    [/<meta property="og:description"[^>]*>/, propertyTag('og:description', meta.socialDescription)],
    ...
    [/<meta name="twitter:description"[^>]*>/, metaTag('twitter:description', meta.socialDescription)],
