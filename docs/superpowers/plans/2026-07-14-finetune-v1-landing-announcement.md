...
- **Open item carried forward (not resolved by this plan):** whether to also add a visible date-anchor in the copy itself (spec §2.5's other half) — left to the owner's judgment during review since it changes the already-approved sentence.
