...
def _build_rewrite_debug_log(
    ...
    log_data = {
        ...
        "rewrite_summary": {
            ...
            "formula_convergence_passes": summary.get("formula_convergence_passes"),
            "selected_formula_portfolio_candidate": summary.get("selected_formula_portfolio_candidate"),
            "best_formula_frontier": summary.get("best_formula_frontier"),
            "formula_gap_contract": summary.get("formula_gap_contract"),
            "formula_portfolio_plan": summary.get("formula_portfolio_plan"),
            "selected_formula_strategy": summary.get("selected_formula_strategy"),
            "remaining_formula_gap": summary.get("remaining_formula_gap"),
            "why_not_below_20": summary.get("why_not_below_20"),
            "turnitin_like_ai_gate": summary.get("turnitin_like_ai_gate"),
            "turnitin_like_ai_score_before": summary.get("turnitin_like_ai_score_before"),
            "turnitin_like_ai_score_after": summary.get("turnitin_like_ai_score_after"),
            "turnitin_like_ai_score_drop": summary.get("turnitin_like_ai_score_drop"),
            "turnitin_like_target_score": summary.get("turnitin_like_target_score"),
            "turnitin_like_target_gap": summary.get("turnitin_like_target_gap"),
            "turnitin_like_target_met": summary.get("turnitin_like_target_met"),
            "turnitin_like_components_before": summary.get("turnitin_like_components_before"),
            "turnitin_like_components_after": summary.get("turnitin_like_components_after"),
            "turnitin_like_component_drops": summary.get("turnitin_like_component_drops"),
            "remaining_turnitin_like_drivers": summary.get("remaining_turnitin_like_drivers"),
            "positive_ai_burden": summary.get("positive_ai_burden"),
            "human_anchor_suppression": summary.get("human_anchor_suppression"),
            "suppression_headroom": summary.get("suppression_headroom"),
            "expected_net_gain": summary.get("expected_net_gain"),
            "observed_driver_movement": summary.get("observed_driver_movement"),
            "weighted_driver_plan": summary.get("weighted_driver_plan"),
            "driver_priority_plan": summary.get("driver_priority_plan"),
            "weighted_driver_drops": summary.get("weighted_driver_drops"),
            "next_formula_driver": summary.get("next_formula_driver"),
            "strict_ai_safe_band_achieved": summary.get("strict_ai_safe_band_achieved"),
            "remaining_strict_safe_band_drivers": summary.get("remaining_strict_safe_band_drivers"),
            "block_driver_map": summary.get("block_driver_map"),
            "geometry_risk_map": summary.get("geometry_risk_map"),
            "feasibility_estimator": summary.get("feasibility_estimator"),
            "distribution_centrality_detector": summary.get("distribution_centrality_detector"),
            "aggressive_geometry_reauthoring": summary.get("aggressive_geometry_reauthoring"),
            "fact_inventory_contract": summary.get("fact_inventory_contract"),
