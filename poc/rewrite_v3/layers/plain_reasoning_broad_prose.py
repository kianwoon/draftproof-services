    ...
    *,
    ...
    payload = {
        ...
        "requirements": [
            ...
            "Represent every content unit listed in central_judgment_plan constraints; do not collapse the document into a summary.",
            "Use rewrite_target_profile targets as the scanner-derived repair contract.",
