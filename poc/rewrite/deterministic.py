...
GENERIC_PHRASE_REPLACEMENTS: Dict[str, List[str]] = {
    ...
    "in recent years": ["lately", "recently", "over the past few years"],
    "has gained significant attention": ["has drawn interest", "is getting noticed"],
    "has been widely studied": ["has seen considerable research", "researchers have explored this extensively"],
    "increasingly important": ["more important", "growing in importance", "hard to ignore"],
    "a growing body of research": ["several studies", "recent findings", "multiple researchers"],
    "the literature suggests": ["studies show", "research indicates", "findings suggest"],
    "further research is needed": ["more work remains", "this needs further study"],
    "sheds light on": ["clarifies", "helps explain", "reveals"],
    "paves the way for": ["opens the door to", "makes possible", "enables"],
    "in conclusion": ["to close", "wrapping up", "in short"],
    "to summarize": ["in short", "put simply", "bottom line"],
    "in summary": ["in short", "to recap", "put briefly"],
    "it is important to note": [""],
    "it is important to note that": [""],

    # Transitions
    "furthermore": ["also", "what's more", "beyond that"],
    "in addition": ["also", "on top of that", "along with this"],
    "moreover": ["also", "what's more", "besides"],
    "additionally": ["also", "as well", "on top of that"],
    "consequently": ["so", "as a result", "because of this"],
    "therefore": ["so", "as a result", "that means"],
    "thus": ["so", "meaning", "which means"],
    "hence": ["so", "for this reason"],
    "accordingly": ["so", "given this"],
    "nevertheless": ["still", "even so", "and yet"],
    "nonetheless": ["still", "even so", "yet"],
    "notwithstanding": ["despite this", "even with this"],
    "as a result": ["because of this", "so", "this led to"],
    "in other words": ["that is", "meaning", "put differently"],
    "for example": ["say", "for instance", "consider"],
    "for instance": ["say", "take", "consider"],
    "in particular": ["especially", "notably", "specifically"],
    "specifically": ["in fact", "exactly", "namely"],
    "notably": ["in particular", "interestingly"],

    # Hedges
    "it can be argued": ["one could argue", "some would say"],
    "it is suggested": ["some suggest", "it appears"],
    "it is widely believed": ["many believe", "most people think"],
    "research suggests": ["studies suggest", "evidence points to"],
    "studies indicate": ["studies show", "findings suggest"],
    "it is generally accepted": ["most agree", "the consensus is"],
    "there is evidence": ["evidence shows", "data shows"],
    "it has been shown": ["studies show", "research shows"],
