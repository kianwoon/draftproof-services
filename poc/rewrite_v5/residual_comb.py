...
def build_residual_cluster_route_plan_prompt(*, section: SectionUnit, local_goal: dict[str, Any] | None = None) -> str:
    ...
    payload = {
        ...
        "planning_rules": [
            ...
            "Any added bridge, specificity, or framing must be traceable to cluster.source_text, before_context, after_context, source_event_beats, or source_phrase_anchors; do not use outside knowledge.",
...
def _custom_route_writer_method() -> list[str]:
    return [
        ...
        "Any new connective wording, specificity, or framing must be traceable to source content or nearby context.",
...
def build_risky_window_cleanup_prompt(
    *,
    ...
    payload = {
        ...
        "constraints": [
            "Any added bridge, specificity, or framing must be traceable to source_window or nearby context; do not use outside knowledge.",
...
def build_unsafe_cluster_cleanup_prompt(
    *,
    ...
    payload = {
        ...
        "constraints": [
            "Any added bridge, specificity, or framing must be traceable to source_cluster or nearby context; do not use outside knowledge.",
