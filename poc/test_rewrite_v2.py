...
assert_test(len(plan.auto_fixable) == 5, f"5 auto-fixable (got {len(plan.auto_fixable)})")
assert_test(len(plan.manual_required) == 1, f"1 manual (got {len(plan.manual_required)})")
